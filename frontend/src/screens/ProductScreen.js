        ...
        <> */}
          <div className="productscreen__left">
            ...
            <div className="left__info">
              ...
              <p>Price: $499.99</p>
              <p>Description: Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut aliquam repellendus necessitatibus, ipsam sed natus 
              </p>
            </div>
          </div>
          <div className="productscreen__right">
            <div className="right__info">
              <p>
                Price:
                <span>$499.99</span> {/* span tag will render the price */}
              </p>
              <p>
                Status:
                <span>In stock
